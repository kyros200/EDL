...
function love.load()
    ...
    retCo = nil --Esse e o retangulo estetico yay
end
    ...
    me = {
        ...
        co = coroutine.create(function (dt)
            --[[
                Trabalho 8
                Corrotina
                A corrotina é criada aqui. Ela é resumida na linha 140 (logo, em todo update) e no love.draw é desenhado na linha 235, tudo se baseando na variavel retCo.
            --]]
            while true do
...
function createCore()
    --[[
        Trabalho 8
        Closure
        O retorno dessa funcao e uma funcao q retorna as caracteristicas da Core (o circulo do jogo). veja linhas 164 e 165.
    --]]
